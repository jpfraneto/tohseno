...
`tohseno@1.0.2` is the dependency-free Node 20+ front door for the native
TOHSENO 1.0.2 Mac product. It is not the factory: it locates or securely
...
The npm and native product versions are exact peers. The 1.0.2 package refuses
