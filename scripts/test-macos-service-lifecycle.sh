...
[ "$("$candidate" --version)" = "tohseno 1.0.0" ] ||
  fail "the service lifecycle requires a TOHSENO 1.0.0 debug binary"
...
assert value.get("service_version") == "1.0.0"
...
assert health.get("service_version") == "1.0.0"
