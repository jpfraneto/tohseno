...
[ "$("$candidate" --version)" = "tohseno 1.0.2" ] ||
  fail "the service lifecycle requires a TOHSENO 1.0.2 debug binary"
...
assert value.get("service_version") == "1.0.2"
...
assert health.get("service_version") == "1.0.2"
