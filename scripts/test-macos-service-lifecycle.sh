...
[ "$("$candidate" --version)" = "tohseno 0.9.0" ] ||
  fail "the service lifecycle requires a TOHSENO 0.9.0 debug binary"
...
assert value.get("service_version") == "0.9.0"
...
assert health.get("service_version") == "0.9.0"
