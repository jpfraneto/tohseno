...
expected_url="https://github.com/jpfraneto/tohseno/releases/download/v0.8.4/$artifact"
...
printf '%s\n' \
  "https://github.com/jpfraneto/tohseno/releases/download/v0.8.4/$binary_name" \
  "https://github.com/jpfraneto/tohseno/releases/download/v0.8.4/$helper_name" \
  "https://github.com/jpfraneto/tohseno/releases/download/v0.8.4/$materials_name" \
  "https://github.com/jpfraneto/tohseno/releases/download/v0.8.4/SHA256SUMS" |
...
"$install_root/bin/tohseno" --version |
  grep -Fqx 'tohseno 0.8.4'
"$install_root/bin/tohseno-apple-identity" --version |
  grep -Fqx 'tohseno-apple-identity 0.8.4'
...
printf '%s\n' \
  "installing TOHSENO v0.8.4 - https://github.com/jpfraneto/tohseno" \
...
printf '%s\n' "Stable 0.8.4 installer regressions passed."
