...
expected_url="https://github.com/jpfraneto/tohseno/releases/download/v0.8.0/$artifact"
...
printf '%s\n' \
  "https://github.com/jpfraneto/tohseno/releases/download/v0.8.0/$binary_name" \
  "https://github.com/jpfraneto/tohseno/releases/download/v0.8.0/$helper_name" \
  "https://github.com/jpfraneto/tohseno/releases/download/v0.8.0/$materials_name" \
  "https://github.com/jpfraneto/tohseno/releases/download/v0.8.0/SHA256SUMS" |
...
"$install_root/bin/tohseno" --version |
  grep -Fqx 'tohseno 0.8.0'
"$install_root/bin/tohseno-apple-identity" --version |
  grep -Fqx 'tohseno-apple-identity 0.8.0'
...
printf '%s\n' \
  "installing TOHSENO v0.8.0 - https://github.com/jpfraneto/tohseno" \
...
printf '%s\n' "Stable 0.8.0 installer regressions passed."
