...
expected_url="https://github.com/jpfraneto/tohseno/releases/download/v0.7.1/$artifact"
...
printf '%s\n' \
  "https://github.com/jpfraneto/tohseno/releases/download/v0.7.1/$binary_name" \
  "https://github.com/jpfraneto/tohseno/releases/download/v0.7.1/$helper_name" \
  "https://github.com/jpfraneto/tohseno/releases/download/v0.7.1/$materials_name" \
  "https://github.com/jpfraneto/tohseno/releases/download/v0.7.1/SHA256SUMS" |
...
printf '%s\n' \
  "installing TOHSENO v0.7.1 - https://github.com/jpfraneto/tohseno" \
...
printf '%s\n' "Stable 0.7.1 installer regressions passed."
