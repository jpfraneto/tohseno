...
expected_url="https://github.com/jpfraneto/tohseno/releases/download/v0.7.2/$artifact"
...
printf '%s\n' \
  "https://github.com/jpfraneto/tohseno/releases/download/v0.7.2/$binary_name" \
  "https://github.com/jpfraneto/tohseno/releases/download/v0.7.2/$helper_name" \
  "https://github.com/jpfraneto/tohseno/releases/download/v0.7.2/$materials_name" \
  "https://github.com/jpfraneto/tohseno/releases/download/v0.7.2/SHA256SUMS" |
...
"$install_root/bin/tohseno" --version |
  grep -Fqx 'tohseno 0.7.2'
"$install_root/bin/tohseno-apple-identity" --version |
  grep -Fqx 'tohseno-apple-identity 0.7.2'
...
printf '%s\n' \
  "installing TOHSENO v0.7.2 - https://github.com/jpfraneto/tohseno" \
...
printf '%s\n' "Stable 0.7.2 installer regressions passed."
