...
Requires TeX Live with XeLaTeX (fonts used: EB Garamond, IBM Plex Mono —
...
Typography: darkroom palette (near-black ink `#11100e`, silver-halide grey
`#77736b`, signal `#ff9d18`). Page numbers are exposure numbers.
