export const PRODUCT = Object.freeze({
  ...
  copy: {
    BRAND: "TOHSENO",
    HEADER_NOTE: "From one prompt to an iOS app",
    HERO_META_DESCRIPTION: "From one prompt to an iOS app on your phone. No logins — not for you, not for your users. A seed phrase instead of a signup form.",
    HERO_HEADLINE: "ONE SHOT.",
    HERO_LEDE: "From one prompt to an iOS app on your phone. No logins — not for you, not for your users. A seed phrase instead of a signup form.",
    HERO_COPY_LABEL: "COPY",
    HERO_COPIED_LABEL: "COPIED",
    HERO_STEP_1: "run the one-liner",
    HERO_STEP_2: "hand your coding agent one sentence",
    HERO_STEP_3: "run the app",
    HERO_REQUIREMENTS: "Needs git, a coding agent, and Xcode on a Mac. The script is a small, pinned, inspectable bootstrap: it accepts no secrets, sends no telemetry, and deploys nothing.",
    ...
    FOOTER_DOCTRINE: "Cryptography instead of accounts. Yours from birth.",
  },
});
