export const PRODUCT = Object.freeze({
  ...
  copy: {
    ...
    BRAND: "TOHSENO",
    HEADER_NOTE: "Open rails for continuity apps",
    HERO_META_DESCRIPTION: "Copy one command. Your coding agent builds a continuity app on open, ejectable rails.",
    HERO_HEADLINE_1: "Copy one command.",
    HERO_HEADLINE_2: "Your agent builds the app.",
    HERO_LEDE: "TOHSENO is the open rails for continuity apps: software built around one meaningful action you return to. The command creates a workspace. You distill what you want into MASTER_PROMPT.md. Your coding agent builds it inside the guardrails.",
    HERO_COPY_LABEL: "COPY",
    HERO_COPIED_LABEL: "COPIED",
    HERO_REQUIREMENTS: "Needs git and a coding agent on your machine. The script is a small, pinned, inspectable bootstrap: it accepts no secrets, sends no telemetry, and deploys nothing.",
    HERO_LINKS_ARIA_LABEL: "More about TOHSENO",
    HERO_REPO_LINK: "Source, docs, and doctrine on GitHub",
    HERO_INTAKE_LINK: "Prefer it run for you? Managed intake",
