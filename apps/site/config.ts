export const PRODUCT = Object.freeze({
  ...
  copy: {
    ...
    HERO_META_DESCRIPTION: "One command, one sentence to your coding agent, one working app. No logins — not for you, not for your users. A seed phrase instead of a signup form; data stays on the device.",
    HERO_HEADLINE: "One command. One sentence. One app.",
    HERO_LEDE: "Run the one-liner, tell your coding agent what to build, and get a working app with no logins — not for you, not for your users. A seed phrase instead of a signup form. Data stays on the device.",
    HERO_COPY_LABEL: "COPY",
    HERO_COPIED_LABEL: "COPIED",
    HERO_STEP_1: "run the one-liner",
    HERO_STEP_2: "tell your agent what to build",
    HERO_STEP_3: "run your app",
